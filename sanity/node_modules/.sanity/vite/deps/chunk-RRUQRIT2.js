...
var visionUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources-bPLLJ09x-POCF4KYZ.js")
});
var visionTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      component: (0, import_react.lazy)(() => import("./SanityVision-0TYSjevX-QQABK6PL.js")),
      options: config,
      router: route.create("/*")
    }],
    i18n: {
...
//# sourceMappingURL=chunk-RRUQRIT2.js.map
