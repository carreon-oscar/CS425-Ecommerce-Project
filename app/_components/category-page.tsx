  ...
  return (
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-[0]">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              {/* Product grid */}
              <div className="grid grid-cols-1 gap-x-2 gap-y-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-4 mb-12 lg:col-span-3">
                {data.map((product) => (
