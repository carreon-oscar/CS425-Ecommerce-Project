      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        <div className="flex bg-white rounded-2xl shadow-2xl w-2/3 max-w-4xl">
          <div className="w-3/5 p-5">
            <div className="text-left font-bold">Agent</div>
            {/* Login */}
            ...
            <div className="flex flex-col items-center">
              ...
              <a
                href="#"
                className="border-2 border-stone-800 text-slate-800 rounded-full px-12 py-2 inline-block font-semibold hover:bg-stone-800 hover:text-white"
              >
                Login
              </a>
            </div>
          ...
          <div className="w-2/5 bg-stone-800 text-white rounded-tr-2xl rounded-br-2xl py-36 px12">
            ...
            <a
              href="#"
              className="border-2 border-white rounded-full px-12 py-2 inline-block font-semibold hover:bg-white hover:text-slate-800"
            >
              Sign Up
            </a>
          </div>
